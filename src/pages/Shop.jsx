                        ...
                        >
                            ...
                            <div className="p-6 text-center">
                                ...
                                <button
                                    ...
                                    className="px-6 py-2 border border-black text-black rounded-full transition-all duration-300"
                                >
                                    Add to Cart
                                </button>
                            </div>
                    ...
                    <>
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <button
                                            ...
                                            className="text-gray-400 hover:text-black ml-3 transition text-sm"
                                        >
                                            ✕
                                        </button>
                                    </div>
                        ...
                        <div className="mt-8 border-t border-gray-300 pt-4">
                            ...
                            <button
                                ...
                                className="w-full py-3 bg-black text-gray-800 rounded-md hover:bg-gray-800 transition-all duration-300"
                                style={{
                                    backgroundColor: "#000",
                                    color: "#fff",
                                    border: "none",
